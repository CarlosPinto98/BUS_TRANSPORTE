...
class RouteRepositoryTest extends AbstractRepositoryTest {
    ...
    void findByOriginAndDestination() {
        ...
        List<Route> routes = routeRepository.findByOriginAndDestination("Bogotá", "Medellín");
    ...
    void findByOriginContainingIgnoreCaseOrDestinationContainingIgnoreCase() {
