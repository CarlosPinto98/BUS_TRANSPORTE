...
class TicketRepositoryTest extends AbstractRepositoryTest {
    ...
    @Test @DisplayName("Buscar lista de ticket por id y estado de trip")
    void findByTripIdAndStatusTicket() {
        ...
        cancelled.setStatusTicket(StatusTicket.CANCELLED);

        ticketRepository.saveAll(List.of(sold1, sold2, cancelled));

        List<Ticket> soldTickets = ticketRepository.findByTripIdAndStatusTicket(
                trip.getId(), StatusTicket.SOLD);
    ...
    void findByIdWithDetails() {
        ...
        Optional<Ticket> found = ticketRepository.findByIdWithDetails(saved.getId());
    ...
    void shouldSaveTicket() {
        ...
        assertThat(saved.getStatusTicket()).isEqualTo(StatusTicket.SOLD);
