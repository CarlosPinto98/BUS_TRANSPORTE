...
class FareRuleRepositoryTest extends AbstractRepositoryTest {
    ...
    void findByRouteIdAndFromStopIdAndToStopId() {
    ...
    void findDynamicPricingRules() {
        ...
        dynamicRule1.setDynamicPricing(DynamicPricing.ON);

        FareRule staticRule = createFareRule(route, stop2, stop3, "35000");
        staticRule.setDynamicPricing(DynamicPricing.OFF);

        FareRule dynamicRule2 = createFareRule(route, stop1, stop3, "70000");
        dynamicRule2.setDynamicPricing(DynamicPricing.ON);
        ...
        assertThat(dynamicRules).allMatch(fr ->
                fr.getDynamicPricing() == DynamicPricing.ON);
    }
    ...
    void shouldUpdateFareRule() {
        ...
        saved.setDynamicPricing(DynamicPricing.ON);
        ...
        assertThat(updated.getDynamicPricing()).isEqualTo(DynamicPricing.ON);
    }
